...
if __name__ == "__main__":
  ...
  Analyze_for_k_and_d(par_1, n, k_range, 'lap', 'max_degree')
  Analyze_of_n(par_1, 'stud', n_range, input_k, 'max_degree')
  Analyze_of_n(par_1, 'lap', n_range, input_k, 'max_degree')
  ...
  Analyze_for_k_and_d(par_2, n, d_range, 'stud', 'size_max_independent_set')
  ...
  Analyze_for_k_and_d(par_3, n, k_range, 'weib', 'number_of_connectivity_components')
  Analyze_of_n(par_3, 'exp', n_range, input_k, 'number_of_connectivity_components')
  Analyze_of_n(par_3, 'weib', n_range, input_k, 'number_of_connectivity_components')

  print("4) size_max_clique")
  d_range = np.linspace(0.05, 10, 30)
  Analyze_for_k_and_d(par_4, n, d_range, 'exp', 'size_max_clique')
  Analyze_for_k_and_d(par_4, n, d_range, 'weib', 'size_max_clique')
  Analyze_of_n(par_4, 'exp', n_range, input_d, 'size_max_clique')
